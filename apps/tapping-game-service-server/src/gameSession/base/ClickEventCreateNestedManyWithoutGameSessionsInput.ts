...
@InputType()
class ClickEventCreateNestedManyWithoutGameSessionsInput {
...
export { ClickEventCreateNestedManyWithoutGameSessionsInput as ClickEventCreateNestedManyWithoutGameSessionsInput };
